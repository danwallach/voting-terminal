 ...
 */
   ...
   */
    function upgradeDomInternal(optJsClass, optCssClass) {
      if (
        typeof optJsClass === "undefined" && typeof optCssClass === "undefined"
      ) {
        for (var i = 0; i < registeredComponents_.length; i++) {
          upgradeDomInternal(
  ...
  MaterialMenu.prototype.show = function(evt) {
    if (this.element_ && this.container_ && this.outline_) {
      ...
      var callback = (function(e) {
        ...
        // if so, do nothing.
        if (
          e !== evt && !this.closing_ && e.target.parentNode !== this.element_
        ) {
 ...
 */
  ...
  MaterialLayout.prototype.contentScrollHandler_ = function() {
    ...
    var headerVisible = !this.element_.classList.contains(
  ...
  MaterialLayout.prototype.init = function() {
    if (this.element_) {
      ...
      for (var c = 0; c < numChildren; c++) {
        ...
        if (
          child.classList && child.classList.contains(this.CssClasses_.HEADER)
        ) {
          this.header_ = child;
        }
        if (
          child.classList && child.classList.contains(this.CssClasses_.DRAWER)
        ) {
          this.drawer_ = child;
        }
        if (
          child.classList && child.classList.contains(this.CssClasses_.CONTENT)
        ) {
          this.content_ = child;
        }
      }
  ...
  MaterialRipple.prototype.downHandler_ = function(event) {
    ...
    if (event.type === "mousedown" && this.ignoringMouseDown_) {
      ...
      if (event.clientX === 0 && event.clientY === 0) {
        ...
        var clientX = event.clientX !== undefined
          ? event.clientX
